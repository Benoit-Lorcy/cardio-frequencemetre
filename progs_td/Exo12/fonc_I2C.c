/************************************************************************
* TITLE: fonc_I2C.c              
* AUTHOR: J CORBEL A REBOUX              
* DESCRIPTION: fonctions I2C       
* VERSION: 1.0 adaptation carte STM8
************************************************************************/
...
/* DEFINE **************************************************************/
#define FMASTER	2000000L	// frequence MASTER 2MHz
#define FCPU		FMASTER	// frequence CPU 2MHz
...
void Start_I2C(void)
{
	...
	I2C_CR2 = (I2C_CR2 & 0b01110000)| 0b00000001;	// start
...
void Stop_I2C(void)
{
	...
	// wait EV7 : receive register not empty condition
	//test I2C Status Register 1
...
I2C_DR = data;
	...
	while ( (( I2C_SR1 & 0b00000010) == 0)&(( I2C_SR1 & 0b10000000) == 0)); // wait for ADDR =1,  Ack ou wait for TXE=1 ( prêt à envoyer un autre byte)
	dummy=I2C_SR3;
}
