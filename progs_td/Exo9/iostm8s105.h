 ...
 *	Copyright (c) 2010 by COSMIC Software
	...
	1.1 : ajout define type uint16_t,int16_t, uint8_t, int8_t
	1.2 : utilisation typedef
 */
 
 /* DEFINE 
 */
#define EnableGeneralInterrupt() _asm("RIM")


/* TYPEDEF
*/
typedef unsigned int uint16_t; 	// 16 bits unsigned integer 
typedef signed int int16_t; 	// 16 bits signed integer 
typedef unsigned char uint8_t; 	// 8 bits unsigned integer 
typedef signed char int8_t;	// 8 bits signed integer
