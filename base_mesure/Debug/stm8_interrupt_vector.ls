...
2553                     ; 16 @far @interrupt void NonHandledInterrupt (void)
2553                     ; 17 {
2554                     	switch	.text
2555  0000               f_NonHandledInterrupt:
2559                     ; 21 	return;
2562  0000 80            	iret
2586                     ; 24 @far @interrupt void int_PE5(void)
2586                     ; 25 {
2587                     	switch	.text
2588  0001               f_int_PE5:
...
2615  0021               L1561:
2616                     ; 30 	affiche_nombre(sal_bas, 4,4);
2618  0021 4b04          	push	#4
2619  0023 4b04          	push	#4
...
2635  0039 80            	iret
2659                     ; 34 @far @interrupt void int_PD3 (void)
2659                     ; 35 {
2660                     	switch	.text
2661  003a               f_int_PD3:
...
2681                     ; 37 	if(sal_haut < 100) {
2683  0052 b600          	ld	a,_sal_haut
2684  0054 a164          	cp	a,#100
2685  0056 2404          	jruge	L3661
2686                     ; 38 		sal_haut = 240;
2688  0058 35f00000      	mov	_sal_haut,#240
2689  005c               L3661:
2690                     ; 40 	affiche_nombre(sal_haut, 4,4);
2692  005c 4b04          	push	#4
2693  005e 4b04          	push	#4
...
2747  0021 00            	dc.b	page(f_NonHandledInterrupt)
2748  0022 0000          	dc.w	f_NonHandledInterrupt
2749  0024 82            	dc.b	130
2751  0025 00            	dc.b	page(f_NonHandledInterrupt)
2752  0026 0000          	dc.w	f_NonHandledInterrupt
